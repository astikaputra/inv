	...
	<div class="container">
		<div class="container-leftbar">
			...
			<div class="wrap-nav-tools">
				<ul>
					<li>
						<?php echo anchor('main_tools','All');?>
					</li>
					<li>
					...
					<li>
						<?php echo anchor('cashier','CASHIER');?>
					</li>
					<li>
	  	 ...
	  	 <?php foreach($modul as $tools)
			...
			<div class="span2 menu">
				<a href="<?php echo base_url().$tools->modul_url;?>" class="to_modal">
					<img class="wobble-horizontal" src="<?php echo $this->config->item('template').'icon/'.$tools->modul_icon;?>"
