  <div class="container-fluid">
	...
	<div class="well">
			...
			<p class="text-center">Insert Name / Code Item Service : <br />
            <br />
            <input type="text" name="keyword" class="span3 search-query" value="" required placeholder="Name Or Item Service Code"></p>
			<br />
	...
	<?php foreach($items_data as $items) 
			  {?>
            <tr>
			<td><a href="<?php echo base_url();?><?php echo $button_action;?><?php echo $items->Id; ?>" data-target="#traceModal" role="button" data-toggle="modal" class="btn btn-mini btn-primary">trace</a></td>
			<td><?php echo $items->CodeValue;?></td>
			<td><?php echo $items->NameValue;?></td>
			<td><?php echo $items->GS;?></td>
			<td><?php echo $items->Parent;?></td>
			<td><?php echo $items->Loses;?></td>
			<td><?php if($items->RecordStatus='1'){echo  'Active';}else{echo 'Not Active';}?></td>
			</tr>
	<?php } ?>
	</tbody>
</table>
