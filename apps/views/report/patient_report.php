...
<div class="accordion" id="datapatient">
  <div class="accordion-group">
    ...
    <div id="summary" class="accordion-body collapse in">
	  ...
	  <div class="row-fluid">
		...
		<br />
			<div class="progress">
				OPD <div class="bar" style="width: <?php if(($total_patient_opd/($total_patient+1)*100)>=93){echo '95';}else{echo $total_patient_opd/($total_patient+1)*100;};?>%;"><?php echo $total_patient_opd;?>  Patients</div>
			</div>
			<div class="progress">
				IPD<div class="bar" style="width: <?php if(($total_patient_ipd/($total_patient+1)*100)>=93){echo '95';}else{echo $total_patient_ipd/($total_patient+1)*100;};?>%;"> <?php echo $total_patient_ipd;?>  Patients</div>
			</div>
			<div class="progress">
				ETC<div class="bar" style="width: <?php if(($total_patient_etc/($total_patient+1)*100)>=93){echo '95';}else{echo $total_patient_etc/($total_patient+1)*100;};?>%;"><?php echo $total_patient_etc;?>  Patients</div>
			</div>
			<div class="progress">
				MCU<div class="bar" style="width: <?php if(($total_patient_mcu/($total_patient+1)*100)>=93){echo '95';}else{echo $total_patient_mcu/($total_patient+1)*100;};?>%;"><?php echo $total_patient_mcu;?> Patients</div>
			</div>
		</div>
		</div>
		<!-- Detailed Data-->
      ...
      <div class="accordion-inner">
         <div class="row-fluid">
			...
			<!-- Data Tab-->
				<div class="tabbable">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#patientactiveopd" data-toggle="tab">Out Patient Department (OPD)</a></li>
    <li><a href="#patientactiveipd" data-toggle="tab">In Patient Department (IPD)</a></li>
  ...
  <div class="tab-content">
	...
	<table class="table table-striped dttbl">
        <thead>
                <tr>
                  <th>Registration Code</th><th>MR Number</th><th>LOB</th><th>Patient Name</th><th>Gender</th><th>Registration Date</th><th>Registration Time</th><th>Doctor's Name</th><th>Created By</th><th>Total Bill</th>
                </tr>
              </thead>
              <tbody>
      ...
      <div class="accordion-inner">
        <div class="row-fluid">
			...
			<!-- Data Tab-->
				<div class="tabbable">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#patientaclosedopd" data-toggle="tab">Out Patient Department (OPD)</a></li>
    <li><a href="#patientaclosedipd" data-toggle="tab">In Patient Department (IPD)</a></li>
      ...
      <div class="accordion-inner">
        <div class="row-fluid">
			...
			<!-- Data Tab-->
				<div class="tabbable">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#patientacanceledopd" data-toggle="tab">Out Patient Department (OPD)</a></li>
    <li><a href="#patientacanceledipd" data-toggle="tab">In Patient Department (IPD)</a></li>
...
<table class="table table-striped dttbl">
        <thead>
                <tr>
                  <th>Registration Code</th><th>MR Number</th><th>LOB</th><th>Patient Name</th><th>Gender</th><th>Registration Date</th><th>Registration Time</th><th>Doctor's Name</th><th>Modified By</th><th>Total Bill</th>
                </tr>
              </thead>
              <tbody>
...
<table class="table table-striped dttbl">
     ...
     <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle btn btn-info" data-toggle="collapse" data-parent="#summary" href="#retailedpatients">
        <b>Retail Patients </b>
      </a>
    </div>
    <div id="retailedpatients" class="accordion-body collapse">
      <div class="accordion-inner">
        <div class="row-fluid">
			<div class="span12">
<table class="table table-striped dttbl">
        <thead>
                <tr>
                  <th>Registration Date</th><th>Registration Time</th><th>MR Number</th><th>Patient Name</th><th>LOB</th><th>LOS</th>
                </tr>
              </thead>
              <tbody>
			  <?php foreach($retail_patient->result() as $items) 
			  {?>
                <tr>
				  <td><?php echo $items->DateRegistration;?></td>
				  <td><?php echo $items->TimeRegistration;?></td>
                  <td><?php echo $items->MedicalRecordNumber;?></td>
				  <td><?php echo $items->PatientName;?></td>
				  <td><?php echo $items->LOB;?></td>
				  <td><?php echo $items->LOS;?></td>
                </tr>
			<?php }?>
			</tbody>
    </table>
