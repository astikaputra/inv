        ...
        <div class="bar" style="width: 0%;"></div>
			...
			<legend><?php echo $content_title; ?></legend>
				...
				<label class="control-label" >Data Type :</label>
					<div class="controls">
						<label class="checkbox-inline"> <input type="radio" id="inlineCheckbox1" name="datatype" value="all"> Patient With all transaction </label>
						<label class="checkbox-inline">	<input type="radio" id="inlineCheckbox2" name="datatype" value="registration"> Patient Register </label>
						<label class="checkbox-inline">	<input type="radio" id="inlineCheckbox3" name="datatype" value="patientonly"> Patient Only </label>
						<label class="checkbox-inline">	<input type="radio" id="inlineCheckbox3" name="datatype" value="discharge"> Discharge Patients</label>
					</div>
				</div>
