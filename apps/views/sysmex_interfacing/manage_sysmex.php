 <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="bar" style="width: 0%;"></div>
			...
			<button type="button" class="btn" data-toggle="collapse" data-target="#get_transaction">Get Lab Transaction</button> 	<a href="<?php echo base_url().'manage_sysmex/lab_doctor';?>" class="btn">Manage Lab Doctor</a>
