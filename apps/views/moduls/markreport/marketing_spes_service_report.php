...
background-color:#fff;
 ...
 <div class="container-fluid">
			...
			<h4>Radiology Service Details : <?php { if(empty($radiology_service_detail->ItemServiceName)) { echo $servcode; } else { echo $radiology_service_detail->ItemServiceName;} } ?> ( <?php { if (empty($radiology_service_detail->ItemServiceCode)) { } else { echo $radiology_service_detail->ItemServiceCode;} } ?>)</h4>
			<br />
