 <div class="container-fluid">
      <div class="row-fluid">
		...
		<div class="row span8">
				...
				<br />-->
						<div class="dropdown">
							<label class="control-label" for="servicerad" >Identity Card Type :</label>
								<select class="selectpicker form-control" id="servicerad" name="servcode" data-live-search="true">
									<option value="0" selected="selected">All Cardtype</option>
									<?php foreach($card_type_list as $items): ?>
									<option value="<?php echo $items->identitycardtypeid; ?>" ><?php echo $items->IdentityType; ?></option>	
									<?php endforeach; ?>
								</select>
						</div>

				<br />
				<button type="submit" class="btn btn-primary" onClick="load_progress();">Get Patient Report</button>
		</div>
		<?php echo form_close();?>
