...
<div class="tabbable">
  ...
  <div class="tab-content">
    <div id="daily1" class="tab-pane active"> 
			...
			<br />
		<table class="table table-bordered" id="mark_ktp_table">
			<thead>
                <tr>
                  <th>No</th><th>Patient Name</th><th>Address</th><th>Cities</th><th>Email</th><th>Nationality</th><th>Created On</th><th>Modified On</th>
                </tr>
              </thead>
              <tbody>
			  <?php $i=0;
...
<script>
 $(document).ready(function() {
					...
					var MarkTable = $("#mark_ktp_table").dataTable( {
					"aLengthMenu": [[10, 25, 25, 20, 50,-1], [10, 25, 25, 20, 50,"All"]],
					"iDisplayLength": 10,
					"sPaginationType": "full_numbers",
					"sAjaxSource": '<?php echo base_url().'marketing_report/get_ktp_identity_data/'.$servcode;?>',
