			...
			<div class="control-group" id="filterzerodata" style="display:none;">
					...
					<div class="controls">
					 <legend><small>Filter Data</small></legend>
							<label class="radio">
							<input type="radio" name="transaction_type" id="optionsRadios1" value="outstanding_report">
								Outstanding Bill
							</label>
							<label class="radio">
								<input type="radio" name="transaction_type" id="optionsRadios2" value="deposit_report">
								List Deposit
							</label>
							<label class="radio">
								<input type="radio" name="transaction_type" id="optionsRadios2" value="refund_deposit_report">
								Refund Deposit
							</label>
					</div>
...
$("form").submit(
					function(event){
							...
							if(report_type == 'outstanding_report')
								{ dashboardname = 'Outstanding Bill Report'; }
							else if(report_type == 'deposit_report')
								{ dashboardname	= 'Deposit List Report';}
							else if(report_type == 'refund_deposit_report')
								{ dashboardname	= 'Refund Deposit Report';}
							if(startdaterange == '')
							{
