			...
			<legend id="toplegend"><?php echo $content_title; ?> </legend> 	
			 ...
			 <?php echo form_open($form_request,array('class'=>'form-horizontal','id'=>'formsearch'));?>
			  ...
			  <div class="control-group" id="custom_range" style="display:none;">
				...
				<div class="controls"> <input type="text" name="startdate" class="col-md-3" value="" id="dpd1" required placeholder="Start Date"></p></div>
				<label class="control-label" for="CustomRangeEndDater">End Date</label>
				<div class="controls"> <input type="text" name="enddate" class="col-md-3" value="" id="dpd2" required placeholder="End Date"></p></div>
			  </div>		
			<div class="control-group" id="filterzerodata" style="display:none;">
				
					<div class="controls">
					
					 <legend><small>Registration Number</small></legend>
							<input type="text" name="keyword" class="input-md search-query form-control" value="" required placeholder="Registration Code" />
			...
			<br />
			 ...
			 <div class="control-group" id="reportdata" style="display:none;">
				<legend id="dashboard_legend"></legend>
					...
					<div class="row" id="dashboard_data" style="display:none";></div>		
			  </div>
...
$("form").submit(
					function(event){
							...
							var report_type = this['keyword'].value;
							if(report_type != '')
								{ dashboardname = 'Radiology Order Correction'; }
							if(startdaterange == '')
							{
