			...
			<div class="control-group" id="filterzerodata" style="display:none;">
					...
					<div class="controls">
					 <legend><small>Filter Data</small></legend>
							<label class="radio">
							<input type="radio" name="transaction_type" id="optionsRadios1" value="purchase_report">
								Purchase Report
							</label>
							<label class="radio">
								<input type="radio" name="transaction_type" id="optionsRadios2" value="consumption_report">
								Consumption Report
							</label>
					</div>
...
$("form").submit(
					function(event){
							...
							if(report_type == 'purchase_report')
								{ dashboardname = 'Purchase Report'; }
							else if(report_type == 'consumption_report')
								{ dashboardname	= 'Consumption Report';}
							if(startdaterange == '')
							{
