 <div class="container-fluid">
      ...
      <div class="progress progress-striped active" style="display:none;" id="progressbar">
        <div class="bar" style="width: 0%;"></div>
			...
			<div class="well">
			   <?php echo form_open('patient_report/patient_history_filter/',array('class'=>'form-search'));?>
...
<!-- Modal -->
<div class="modal hide fade" style="width:70%; margin: 0 0 0 -450px; " id="patientModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
