   ...
   <div class="container-fluid">
	...
	<div class="well">
			...
			<p class="text-center">Insert Name / Registration Number : <br />
            <br />
            <input type="text" name="keyword" class="span3 search-query" value="" required placeholder="Name Or Registration Number"></p>
			<br />
	...
	<thead>
		<tr>
			<th>Action</th><th>Registration Code</th><th>Bill No</th><th>LOB</th><th>Patient Name</th><th>Registration Time</th><th>Created By</th>
		</tr>
	</thead>
	<tbody>
	<?php foreach($reopenbill_data as $items) 
			  {?>
            <tr>
			<td><a href="<?php echo base_url();?><?php echo $button_detail_action;?><?php echo $items->BillId; ?>/<?php echo $items->RegId; ?>" role="button" class="btn btn-mini btn-primary">Open</a></td>
