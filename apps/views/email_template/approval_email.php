...
<head>
    ...
    <title>MedicOS Notification System</title>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td class="" align="center">
                ...
                <table cellspacing="0" cellpadding="3" class="container">
                    <tr class="">
                        <td colspan="4">
						<center><img src="https://lh6.googleusercontent.com/-TUpx8et-HhI/Uq_J51qVCgI/AAAAAAAACNA/YMoF-Kp4Qio/w236-h62-no/logo.png" alt="siloam hospitals logo">
                       <img src="https://lh3.googleusercontent.com/Pi31Wa4K3p0A7IUYdJCHXHjBWqfWT3SGT048Ln9khQM=w295-h71-no" alt="MedicOS Centric" width="190px" height="62px" style="margin-top:20px;">
						</center>
						</td>
                    </tr>
            ...
            <td bgcolor="#FFFFFF" align="center">
                <table cellspacing="0" cellpadding="3" class="container">
                    <tr>
						...
						<hr>
						<p>
						Hello <strong><?php echo $hod_name;?></strong>
						<br />
						Below are Radiology Department Signed-Off Report list validated by Front Office.
Periode : 01-Dec-2013 to 12-Dec-2012
						<br />
						</p>
			<!--First Data Grid-->			
					...
					<thead>
						...
						<tbody width="100%">
							<tr>
								...
								<td><center>dr. made kurniati, SP Rad</center></td>
			...
			<br />
			<br />
									<button class="btn btn-large btn-block btn-primary" type="button">To Confirm or Modified this report please click this button.</button>
					<br />
					<br />
					
					<address>
					<strong>MedicOS|Centric</strong><br> Hospitals Information System
					</address>
            ...
            <td bgcolor="#FFFFFF" align="center">
                <table cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td>
                            <hr>
                            <p align="center"><small>Copyright Mochtar Riady Institute for Nanotechnology 2012. All Rights Reserved.
							<br /> 
							Medicos Centric Alert System</small>
							</p>
                        </td>
                    </tr>
                </table>
