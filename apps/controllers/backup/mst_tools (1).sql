...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2015 at 12:48 AM
...
(2, 'Paediatric', 3),
(3, 'Maternity Nurse', 3),
(4, 'Front Office IPD', 1),
(5, 'Admission IPD', 1),
(6, 'Cashier IPD', 1),
(7, 'Billing / Backoffice', 1),
(8, 'Operator', 1),
(9, 'Pharmacy OPD', 1),
(10, 'Call Center', 1),
(11, 'Corporate Insurance', 1),
(12, 'Triage', 1),
(13, 'MCU', 1),
(14, 'GP Clinic', 1),
(15, 'Radiology', 1),
(16, 'Emergency', 1),
(17, 'Laboratory', 2),
(18, 'Management Office', 2),
(19, 'Medical Record', 2),
(20, 'Receiving', 2),
(21, 'Pharmacy Central', 2),
(22, 'Meeting Room', 2),
(23, 'Cafetaria', 2),
(24, 'Ruang Server', 2),
(25, 'ICU / NICU', 3),
(26, 'BPJS OPD', 3),
(27, 'OT', 3),
(28, 'Cathlab / Endoscopy', 3),
(29, 'HD', 3),
(30, 'Medical Rehab', 3),
(31, 'Chemotherapy', 3),
(32, 'OPD Nursestation', 3),
(33, 'OPD Clinic', 3),
(34, 'Maternity', 3),
(35, 'Paediatric', 3),
(36, 'Medical Anchilary', 3);
...
(10, 'SHDP', '10.83.128.6', 'sa', 'MRINlt3.', 'MedicOS.Centric-SHDP', 'Production');
...
CREATE TABLE IF NOT EXISTS `mst_logs` (
  ...
  PRIMARY KEY (`logs_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=102511 ;
...
(102510, 58, 2, 'astika from IP ::1', '2015-01-29 15:16:58');
...
(20, NULL, 'MST 017', 'Used Cartridge', 'Used Cartridge Per Departement', 'cartridge.png', 'core/sys_config/use_cartridge', 5, 1),
...
(30, NULL, 'MST 027', 'Patient Marketing Report', 'Data marketing patient report for marketing div', 'patient_report.png', 'marketing_report/marketing_patient_report_filter', 8, 1),
(69, 70, 'MST 018', 'Location Items', 'Modul Location Items', 'company.png', 'core/sys_config/location', 4, 1),
(67, NULL, 'MST 064', 'Data Exchange - Patient Data', 'Get Daily Patient Data For Open His', 'data_exchange.png', 'dataexchange/patientdata', 5, 1),
(71, 70, 'mst_category', 'Category Items', 'Modul Category Items', 'inventory_report.png', 'core/sys_config/category', 9, 1),
...
(58, 'astika', 'zmSjDZotdLTOlXgVyuoikdqRicVV31uK8vwbzntG1dZcD7PMKJUd+nYosBBgukPpkEq69NYb4A2ueh0V4P4Icw==', NULL, 'Astika Putra', 'SHDP', '0812221121', 'asdas', 1, 1, 'oracle');
