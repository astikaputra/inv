...
class Core extends CI_Controller {
	...
	{
		$data['title'] = "Application Project: ".$this->config->item('company_name');
		...
		{
		$data['page']='login';
		$data['message'] = 'Application Project';
...
//				redirect('core/check_user_roles', 'refresh');
			...
			$data['title'] = "Selecting Database -> Application Project :: ".$this->config->item('company_name')." ";
