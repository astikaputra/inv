...
class Daily_doctor_mr_appointment extends CI_Controller 
{ 
   	...
   	function index()
	{
		...
		{	
			...
			$data['form_request'] = "daily_doctor_mr_appointment/doctor_daily_appointment";
			$data['content_title'] = "Generate Doctor Appointment Report";
			$data['button_action']='daily_doctor_mr_appointment/lookup/';
