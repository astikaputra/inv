...
//        $objWriter->save('php://output');  
        $objWriter->save("assets/uploads/document/$filename");
        //header("location: ".base_url()."assets/uploads/document/$filename");
        //unlink(base_url()."assets/uploads/document/$filename");
    }
