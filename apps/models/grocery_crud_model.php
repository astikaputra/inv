...
class grocery_CRUD_Model  extends CI_Model  {
    ...
    function get_field_types_basic_table()
    {
		...
		if($this->db->dbdriver == 'sqlsrv')
			{
			$sql = "select column_name as Field, data_type+'('+convert(varchar(255), ISNULL(character_maximum_length,10))+')' as Type, is_nullable as [Null], case when ordinal_position = 1 then 'PRI' else '' end as [Key], column_default as [Default], '' as Extra from information_schema.columns where table_name = '{$this->table_name}'";
